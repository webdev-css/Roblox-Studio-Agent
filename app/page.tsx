...
function makeStyles(t: ThemeTokens, isMobile: boolean) {
  return {
    root: { position: "fixed" as const, inset: 0, display: "flex", flexDirection: "column" as const, background: t.bg, color: t.text, fontFamily: t.fontFamily, fontSize: 14 },
    ...
    brandTextWrap: { display: "flex", flexDirection: "column" as const },
    ...
    userChipText: { whiteSpace: "nowrap" as const },
    body: { flex: 1, display: "flex", minHeight: 0, position: "relative" as const },
    overlay: { position: "fixed" as const, inset: 0, top: 60, background: "rgba(0,0,0,0.55)", zIndex: 40 },
    sidebar: { top: 60, bottom: 0, left: 0, width: 280, background: t.bgElevated, borderRight: `1px solid ${t.border}`, display: "flex", flexDirection: "column" as const, padding: 12, zIndex: 50, transition: "transform .25s ease" },
    sidebarSection: { padding: "8px 4px" },
    sectionLabel: { fontSize: 11, fontWeight: 700, textTransform: "uppercase" as const, color: t.textFaint, marginBottom: 8 },
    ...
    sessionList: { display: "flex", flexDirection: "column" as const, gap: 4, maxHeight: 200, overflowY: "auto" as const },
    ...
    sessionTitle: { flex: 1, fontSize: 13, whiteSpace: "nowrap" as const, overflow: "hidden", textOverflow: "ellipsis" },
    sessionDelete: { width: 24, height: 24, background: "transparent", border: "none", color: t.textFaint, cursor: "pointer" },
    explorerTree: { overflowY: "auto" as const, flex: 1, borderRadius: 10, border: `1px solid ${t.border}`, background: t.bgPanel, padding: 6 },
    ...
    main: { flex: 1, display: "flex", flexDirection: "column" as const, minWidth: 0, background: t.bg },
    messages: { flex: 1, overflowY: "auto" as const, padding: 20, display: "flex", flexDirection: "column" as const, gap: 16 },
