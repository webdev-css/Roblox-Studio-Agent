...
`,
  ...
  if (isGui) {
    return {
      filename: "AdvancedGuiEngine.lua",
      content: `--!strict
-- AdvancedGuiEngine.lua  |  Generated by Roblox AI Studio
-- A premium, draggable modern UI panel with hover effects and smooth transitions.
...
if playerGui:FindFirstChild("AdvancedPanel") then
	playerGui.AdvancedPanel:Destroy()
end
...
mainFrame.Size = UDim2.fromOffset(0, 0) -- Starts at 0 for entrance animation
...
stroke.Color = Color3.fromRGB(109, 94, 252)
stroke.Thickness = 2
...
-- Hide bottom corners of topbar to blend seamlessly into the main frame
local topBarExtension = Instance.new("Frame")
topBarExtension.Size = UDim2.new(1, 0, 0, 12)
topBarExtension.Position = UDim2.new(0, 0, 1, -12)
topBarExtension.BackgroundColor3 = Color3.fromRGB(25, 28, 36)
...
title.Text = "MrFireXH1K1N6 Panel"
...
closeBtn.MouseLeave:Connect(function()
	TweenService:Create(closeBtn, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(244, 63, 94)}):Play()
end)

closeBtn.MouseButton1Click:Connect(function()
	TweenService:Create(mainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
		Size = UDim2.fromOffset(0, 0),
		Position = UDim2.new(0.5, 0, 0.5, 300) -- Dips down as it shrinks
	}):Play()
	task.wait(0.3)
	screenGui:Destroy()
end)
...
print("[UIEngine] Advanced panel loaded successfully.")
`,
    };
  }
      ...
      messages: [
        {
          ...
          role: "ai",
          text:
            "👋 Welcome to Roblox AI Studio! Ask me to write Luau scripts (try \"make a custom gui\") or to generate crazy GUI concept images (try \"generate crazy GUI icons\"). Pick a model in the sidebar and let's build.",
          createdAt: Date.now(),
          code: null,
          images: null,
        },
